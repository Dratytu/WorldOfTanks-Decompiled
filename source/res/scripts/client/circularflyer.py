...
class CircularFlyer(BigWorld.UserDataObject):
    ...
    def __init__(self):
        ...
        self.__update_callback_id = None  # ID of the update callback.
        self.__model = None  # The 3D model of the flyer.
        self.__model_matrix = None  # The transformation matrix of the model.
        self.__sound = None  # The sound associated with the flyer.
        self.__animator = None  # The animation controller for the model.
    ...
    def __clear(self):
        """
        Clears all resources associated with the flyer.
        """
    ...
    def __on_resources_loaded(self, resource_refs):
        """
        Called when the resources for the flyer have been loaded.
        """
    ...
    def __update(self):
        """
        Updates the state of the flyer.
        """
        self.__update_callback_id = None
        ...
        if self.__current_angle > 2 * math.pi:
            ...
            self.__current_angle += 2 * math.pi
        radial_position = Vector3(self.radius * math.sin(self.__current_angle), 0,
                                  self.radius * math.cos(self.__current_angle))
